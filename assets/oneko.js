...
(function oneko() {
  ...
  function frame() {
    ...
    // Check proximity/overlap with Clawd mascot to trigger startled jump
    ...
    if (clawd && typeof window.triggerClawdJump === 'function') {
      ...
      const clawdCenterX = rect.left + rect.width / 2;
      const clawdCenterY = rect.top + rect.height / 2;
      const dist = Math.hypot(nekoPosX - clawdCenterX, nekoPosY - clawdCenterY);
      if (dist < 70) {
