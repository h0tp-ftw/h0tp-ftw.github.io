...
- `port-logic.js` (~1500 lines) does everything: GitHub data loading (repos, stars, following), Chart.js portfolio rendering, scroll handling, theme toggle, VanillaTilt, rotating text animation
